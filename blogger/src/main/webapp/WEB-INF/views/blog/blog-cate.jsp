...
<body>
<!--cate==============================-->	
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/cate/cate.css">
...
<div class="colorlib-loader"></div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 breadcrumbs text-center">
						<h2><a href="${pageContext.request.contextPath}/${authUser.userid}/about">블로그 관리</h2>
						<div class="col-md-12">
							<p2><a href="${pageContext.request.contextPath}/${authUser.userid}/blog/cate"><strong>카테고리 관리</strong></a>/
							<a href="${pageContext.request.contextPath}/${authUser.userid}/post">글 관리</a></p2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<label for="blogtitle">새로운 카테고리 추가</label></br></br>			
					</div>
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-6">
								<div class="row form-group">
									<div class="col-md-12">
										<h5>카테고리명</h5>					
										<input type="text" name="catename" class="form-control" placeholder="카테고리명">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-12">
								...
								<div class="form-group">
									<input type="submit" id="btnAddCate" value="카테고리 추가" class="btn btn-primary">
								</div>
							</div>  <!-- class="col-md-6" -->															
						</div> <!-- class="row" -->
					</div> <!-- class="col-md-12" -->					
	...
	$("#btnAddCate").on("click", function(){
		...
		var userid = "${blogDto.userid}";
		console.log(catename);
		console.log(description);
		console.log(userid);
		
		categoryDto = {catename: catename,
	...
	/* 게시물을 화면에 표현합니다. */
	function render(categoryDto, updown) {
		var str = "" +
				"<tr>"+
					"<td>" + categoryDto.cateno + "</td>" +
					"<td>" + categoryDto.catename + "</td>" +
					"<td>" + categoryDto.cnt + "</td>" +
					"<td>" + categoryDto.description + "</td>" +
					"<td><img style='boarder:0px' class='btn_cateDel' data-cateno='" + categoryDto.cateno + "'  data-cnt='" + categoryDto.cnt + "'  src='${pageContext.request.contextPath}/resources/images/delete.jpg'></td>" +
				"</tr>"
