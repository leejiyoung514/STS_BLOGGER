			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 breadcrumbs text-center">
						<h2><a href="${pageContext.request.contextPath}/${blogDto.userid}">${blogDto.blogtitle}</a></h2>
						<p><span><a href="${pageContext.request.contextPath}/">Home</a></span> / <span>Blog</span></p>
					</div>
				</div>
			</div>
		</aside>
					...
					<div class="col-md-9 content">
						<div class="row row-pb-md">
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-1.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
								...
								<div class="blog-entry">
									<div class="blog-slider">
										<div class="owl-carousel">
											<div class="item">
												<a href="blog.html" class="image-popup-link"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-2.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
											</div>
											<div class="item">
												<a href="blog.html" class="image-popup-link"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-4.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
											</div>
										</div>
									</div>
									<div class="desc">
						...
						<div class="row row-pb-md">
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-4.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
							...
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-5.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
											<span class="cat"><a href="#">Events</a></span>
						...
						<div class="row row-pb-md">
							<div class="col-md-12">
								<div class="blog-entry">
									<div class="blog-img">
										<div class="video colorlib-video" style="background-image: url(${pageContext.request.contextPath}/resources/images/blog/blog-8.jpg);">
						...
						<div class="row row-pb-md">
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-9.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
											<span class="cat"><a href="#">Events</a></span>
							...
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-10.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
											<span class="cat"><a href="#">Events</a></span>
						...
						<div class="row row-pb-md">
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-12.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
											<span class="cat"><a href="#">Events</a></span>
							...
							<div class="col-md-6">
								<div class="blog-entry">
									<div class="blog-img">
										<a href="blog.html"><img src="${pageContext.request.contextPath}/resources/images/blog/blog-13.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
									</div>
									<div class="desc">
										<p class="meta">
											<span class="cat"><a href="#">Events</a></span>
								...
								<p>
									<ul class="category">
										<c:forEach items="${cateList}" var="catelist">
											<li><a href="${pageContext.request.contextPath}/${blogDto.userid}?cateno=${catelist.cateno}"><i class="icon-check"></i>${catelist.catename}</a></li>
										</c:forEach>
									</ul>
								</p>
							</div>
