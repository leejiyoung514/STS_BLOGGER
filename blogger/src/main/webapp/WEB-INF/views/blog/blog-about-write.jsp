			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 breadcrumbs text-center">
						<h2><a href="${pageContext.request.contextPath}/${authUser.userid}/about/update">계정관리</h2>
						<!-- <div class="col-md-3">
							<p>&nbsp;</p>
						</div> -->
						<div class="col-md-12">
							<p2><a href="${pageContext.request.contextPath}/${authUser.userid}/about/update"><strong>프로필 수정</strong></a>/
							<a href="${pageContext.request.contextPath}/${authUser.userid}/account/update">회원정보 재설정</a></p2>
						</div>
					<!-- 	<div class="col-md-3">
							<p>&nbsp;</p>
						</div> -->
						...
						<div class="row">
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-12">
											<label for="logoimage">로고이미지</label></br>
											<c:if test="${blogDto.logofile eq 'default'}">
												<img width="500" height="400" src="${pageContext.request.contextPath}/resources/images/default.jpg" >
											</c:if>
											<c:if test="${blogDto.logofile ne 'default'}">
												<img width="500" height="400" src="${pageContext.request.contextPath}/fileupload/${blogDto.logofile}">
											</c:if>
										</div>
									</div>
								</div>
								<form action="${pageContext.request.contextPath}/${authUser.userid}/about/update" method="post" enctype="multipart/form-data">
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-12">
											<label for="blogtitle">블로그제목</label></br>
											 <input type="text" name="blogtitle" class="form-control"  value="${blogDto.blogtitle}" placeholder="제목을 입력해주세요">
										</div>
									</div>
									<div class="row form-group">
										<div class="col-md-12">
											<label for="logofile">이미지파일을 선택해주세요.</label></br>
											<input type="file" name="file" class="form-control">
										</div>
									</div>
									<div class="row form-group">
										<div class="col-md-12">
											<label for="blogcontent">프로필내용</label></br>
											<textarea name="blogcontent" id="blogcontent" cols="30" rows="10"
												class="form-control" placeholder="메시지를 입력해주세요">${blogDto.blogcontent}</textarea>
										</div>
									</div>
									<div class="form-group">
										<input type="submit" value="기본설정 변경 " class="btn btn-primary">
									</div>
								</div> <!-- class="col-md-6" -->															
							</form>
						</div>
...
$(function(){
	...
	$("#btnUpdate").click(function(){
		document.form1.action="${pageContext.request.contextPath}/${authUser.userid}/about/update";
