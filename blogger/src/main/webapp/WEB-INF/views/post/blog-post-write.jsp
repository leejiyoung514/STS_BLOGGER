										...
										<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/${authUser.userid}/post/write">
											<div class="col-md-12">
												<div class="col-md-12">
													...
													<input type="text" name="title" style="width:580px;" placeholder="&nbsp;제목">
												</div>
												<div class="col-md-12"><br/>
													<textarea name="postcontent" id="postcontent" cols="100" rows="10" placeholder="내용을 입력해주세요"></textarea><br/>
<!-- <script>
CKEDITOR.replace("postcontent",{
	filebrowserUploadUrl:"${pageContext.request.contextPath}/imageUpload"
													...
													<button type="button" id="btnSave" >글 등록</button>
...
$(function() {
	...
	function list(page) {
		location.href = "${pageContext.request.contextPath}/post/list?curPage=" + page;
	}
	...
	"<input type='hidden' name='files["+i+"]' value='" + $(this).val()+"'>";
		...
		$(".fileDrop").on("drop",function(e){
			...
			//폼 데이터에 첨부파일 추가
			var formData=new FormData();//폼에 file 변수추가 
